"""
Report Explorer - lightweight query/report menu with search and tree
navigation.
"""
...
DEFAULT_REPORTS = [
    ...
    },
    {
        ...
        "category": "Accounting",
        "name": "Balance Sheet",
        "class_name": "BalanceSheetWidget",
    },
    {
        "domain": "Finance",
        "category": "Accounting",
        "name": "Year-End Close Worksheet",
        "class_name": "YearEndCloseWidget",
    },
    {
        "domain": "Finance",
        "category": "Accounting",
        "name": "Ledger Integrity",
        "class_name": "LedgerIntegrityWidget",
    },
    {
        "domain": "Finance",
        "category": "Accounting",
    ...
    },
    {
        "domain": "Finance",
        "category": "Accounting",
        "name": "Vendor Receipt-Banking Audit",
        "class_name": "VendorReceiptBankingAuditWidget",
    },
    {
        "domain": "Finance",
        "category": "Accounting",
        "name": "General Ledger",
        "class_name": "GeneralLedgerWidget",
    },
    {
        "domain": "Finance",
        "category": "Accounting",
        "name": "GIFI Mapping",
        "class_name": "GIFIMappingWidget",
    },
    {
        "domain": "Finance",
        "category": "Fleet",
...
class ReportExplorerWidget(QWidget):
    ...
    def __init__(self, menu_file: Path | None = None) -> None:
        super().__init__()
        self.menu_file = (
            menu_file or Path(__file__).parent / "report_menu.json"
        )
    ...
    def _load_reports(self) -> object:
        if self.menu_file.exists():
            try:
                ...
                logger.warning(
                    "Failed to load report menu '%s': %s",
                    self.menu_file,
                    exc,
                )
        return DEFAULT_REPORTS

    def _build_search_bar(self) -> object:
        bar = QHBoxLayout()
    ...
    def _populate_tree(self) -> None:
        ...
        for rpt in self.reports:
            ...
            cats = (
                domains[domain].data(0, Qt.ItemDataRole.UserRole + 1)
                or {}
            )
    ...
    def _on_activate(self, item, _column) -> None:
        meta = item.data(0, Qt.ItemDataRole.UserRole) or {}
