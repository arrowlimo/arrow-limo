...
Overall business/company management - financials, taxes, licenses, insurance,
assets, vendors
"""
...
class BusinessEntityDialog(QDialog):
    ...
    def create_company_info_tab(self) -> object:
        ...
        self.incorporation_province.addItems(
            ["Alberta", "British Columbia", "Federal", "Other"]
        )
    ...
    def create_financials_tab(self) -> object:
    ...
    def create_taxes_tab(self) -> object:
    ...
    def create_licenses_tab(self) -> object:
    ...
    def create_banking_tab(self) -> object:
    ...
    def create_liabilities_tab(self) -> object:
        ...
        payment_btn.setToolTip(
            "Record a manually received payment against this loan; no online"
            "processing."
        )
    ...
    def create_assets_tab(self) -> object:
    ...
    def create_vendors_tab(self) -> object:
    ...
    def create_planning_tab(self) -> object:
        ...
        try:
            with DatabaseContext(self.db, auto_commit=False) as cur:
                ...
                cur.execute("""
                    ...
                    FROM charters
                    WHERE EXTRACT(YEAR FROM charter_date) = EXTRACT(YEAR FROM
                    CURRENT_DATE)
                """)
                ...
                # Calculate profit
                profit = (
                    self.total_revenue.value() - self.total_expenses.value()
                )
            ...
            QMessageBox.critical(
                self, "Error", f"Failed to load business data: {e}"
            )
    ...
    def generate_report(self) -> None:
        QMessageBox.information(
            self, "Info", "Generate business report (to be implemented)"
        )

    def log_tax_filing(self) -> None:
        QMessageBox.information(
            self, "Info", "Log tax filing (to be implemented)"
        )

    def gst_remittance(self) -> None:
        QMessageBox.information(
            self, "Info", "GST remittance (to be implemented)"
        )

    def add_license(self) -> None:
        QMessageBox.information(
            self, "Info", "Add license (to be implemented)"
        )

    def renew_license(self) -> None:
        QMessageBox.information(
            self, "Info", "Renew license (to be implemented)"
        )

    def add_insurance_policy(self) -> None:
        QMessageBox.information(
            self, "Info", "Add insurance policy (to be implemented)"
        )

    def file_insurance_claim(self) -> None:
        QMessageBox.information(
    ...
    def record_loan_payment(self) -> None:
        QMessageBox.information(
            self, "Info", "Record loan payment (to be implemented)"
        )

    def add_asset(self) -> None:
        QMessageBox.information(self, "Info", "Add asset (to be implemented)")

    def dispose_asset(self) -> None:
        QMessageBox.information(
            self, "Info", "Dispose asset (to be implemented)"
        )
    ...
    def add_compliance_requirement(self) -> None:
        QMessageBox.information(
            self, "Info", "Add compliance requirement (to be implemented)"
        )

    def mark_reviewed(self) -> None:
        QMessageBox.information(
            self, "Info", "Mark reviewed (to be implemented)"
        )

    def upload_business_doc(self) -> None:
    ...
    def update_goal_progress(self) -> None:
        QMessageBox.information(
            self, "Info", "Update goal progress (to be implemented)"
        )
