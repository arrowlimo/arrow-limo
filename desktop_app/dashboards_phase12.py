...
class BranchLocationConsolidationWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        columns = [
            ...
            {"header": "Drivers", "key": "drivers"},
            {"header": "Vehicles", "key": "vehicles"},
            {"header": "Utilization", "key": "utilization"},
            {"header": "Status", "key": "status"},
        ]
        super().__init__(db, "BranchLocationConsolidation", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class InterBranchPerformanceComparisonWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "InterBranchPerformanceComparison", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ConsolidatedProfitLossWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ConsolidatedProfitLoss", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            ...
            for idx, (loc, rev, exp, profit, margin, change) in enumerate(
                pl_data
            ):
                bold_font = QFont()
...
class ResourceAllocationAcrossPropertiesWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ResourceAllocationAcrossProperties", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class CrossBranchCharteringWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "CrossBranchChartering", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class SharedVehicleTrackingWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "SharedVehicleTracking", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            with DatabaseContext(self.db, auto_commit=False) as cur:
                cur.execute("""
                    SELECT v.vehicle_number, v.vehicle_type, v.year,
                    COALESCE(SUM(COUNT(*)) OVER(), 0)
                    FROM vehicles v
                ...
                if rows:
                    for idx, row in enumerate(rows[:15]):
                        ...
                        self.table.setItem(
                            idx, 0, QTableWidgetItem(str(plate))
                        )
                        self.table.setItem(
                            idx, 1, QTableWidgetItem("Downtown")
                        )
                        self.table.setItem(
                            idx,
                            2,
                            QTableWidgetItem(
                                "Airport" if idx % 2 else "North"
                            ),
                        )
                        ...
                        self.table.setItem(
                            idx,
                            5,
                            QTableWidgetItem(f"${(charters or 0) * 350:.2f}"),
                        )
                        self.table.setItem(idx, 6, QTableWidgetItem("2850"))
                        self.table.setItem(idx, 7, QTableWidgetItem("Active"))
        except Exception as e:
            logger.error(f"Failed to load shared vehicle data: {e}")


class UnifiedInventoryManagementWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "UnifiedInventoryManagement", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class MultiLocationPayrollWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "MultiLocationPayroll", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            ...
            for idx, (
                ...
                self.table.setItem(
                    idx, 6, QTableWidgetItem(f"${cost_charter:.2f}")
                )
...
class TerritoryMappingWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "TerritoryMapping", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class MarketOverlapAnalysisWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "MarketOverlapAnalysis", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class RegionalPerformanceMetricsWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "RegionalPerformanceMetrics", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class PropertyLevelKPIWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "PropertyLevelKPI", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            ...
            for idx, (
                ...
                self.table.setItem(
                    idx, 7, QTableWidgetItem(f"{vehicle_util}%")
                )
...
class FranchiseIntegrationWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "FranchiseIntegration", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class LicenseTrackingWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "LicenseTracking", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class OperationsConsolidationWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "OperationsConsolidation", columns)
        self.db = db
        self.init_ui()
        self.load_data()
