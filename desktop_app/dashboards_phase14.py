...
class CustomReportBuilderWidget(BaseReportWidget):
    """Custom Report Builder - Ad-hoc report creation with full toolset"""

    def __init__(self, db) -> None:
        columns = [
            {"header": "Report Name", "key": "report_name"},
        ...
        super().__init__(db, "CustomReportBuilder", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def init_ui(self) -> None:
        ...
        layout.insertLayout(1, title_layout)
        ...
        try:
            ...
            for idx, (
                ...
                action_btn.clicked.connect(
                    lambda checked, r=idx: self.edit_report(r)
                )
                self.table.setCellWidget(idx, 6, action_btn)
        except Exception as e:
            QMessageBox.critical(
                self, "Error", f"Failed to load reports: {e!s}"
            )
    ...
    def create_new_report(self) -> None:
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            QMessageBox.information(
                self, "Success", "Report created successfully!"
            )
            self.load_data()

    def edit_report(self, row) -> None:
        name = self.table.item(row, 0).text()
        dialog = ReportEditorDialog(self.db, name, self)
        if dialog.exec() == QDialog.DialogCode.Accepted:
            QMessageBox.information(
                self, "Success", "Report updated successfully!"
            )
            self.load_data()
    ...
    def duplicate_report(self) -> None:
        ...
        if row < 0:
            QMessageBox.warning(
                self, "Warning", "Please select a report to duplicate"
            )
            return

        name = self.table.item(row, 0).text()
        QMessageBox.information(
            self, "Success", f"Report '{name}' duplicated as '{name} (Copy)'"
        )
        self.load_data()
    ...
    def delete_report(self) -> None:
        ...
        if row < 0:
            QMessageBox.warning(
                self, "Warning", "Please select a report to delete"
            )
            return

        name = self.table.item(row, 0).text()
        reply = QMessageBox.question(
            self, "Confirm Delete", f"Delete report '{name}'?"
        )
        if reply == QMessageBox.StandardButton.Yes:
            QMessageBox.information(
                self, "Success", "Report deleted successfully!"
            )
            self.load_data()
    ...
    def export_report(self) -> None:
        ...
        if row < 0:
            QMessageBox.warning(
                self, "Warning", "Please select a report to export"
            )
            return

        name = self.table.item(row, 0).text()
        QMessageBox.information(
            self, "Success", f"Report '{name}' exported to CSV"
        )
    ...
    def schedule_report(self) -> None:
        ...
        if row < 0:
            QMessageBox.warning(
                self, "Warning", "Please select a report to schedule"
            )
            return
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            QMessageBox.information(
                self, "Success", "Report scheduled successfully!"
            )
...
class ReportEditorDialog(QDialog):
    ...
    def __init__(self, db, report_name=None, parent=None) -> None:
    ...
    def init_ui(self) -> None:
        ...
        self.type_combo.addItems(
            ["Standard", "Advanced", "Custom", "Dashboard"]
        )
        ...
        self.group_combo.addItems(
            ["None", "By Date", "By Category", "By Owner", "By Status"]
        )
...
class ScheduleReportDialog(QDialog):
    ...
    def __init__(self, parent, report_name) -> None:
        super().__init__(parent)
        self.report_name = report_name
...
class ExecutiveDashboardWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ExecutiveDashboard", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def init_ui(self) -> None:
        ...
        self.table.setHorizontalHeaderLabels(
            ["KPI", "Current", "Target", "YTD", "YoY", "Trend"]
        )
    ...
    def load_data(self) -> None:
        try:
            ...
            for idx, (kpi, current, target, ytd, yoy, trend) in enumerate(
                kpis
            ):
...
class BudgetVsActualWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "BudgetVsActual", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class TrendAnalysisWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "TrendAnalysis", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class AnomalyDetectionWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "AnomalyDetection", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class SegmentationAnalysisWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "SegmentationAnalysis", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class CompetitiveAnalysisWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "CompetitiveAnalysis", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class OperationalMetricsWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "OperationalMetrics", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            ...
            for idx, (metric, this, last, change, target, status) in enumerate(
                metrics
            ):
                self.table.setItem(idx, 0, QTableWidgetItem(str(metric)))
...
class DataQualityReportWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "DataQualityReport", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ROIAnalysisWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ROIAnalysis", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ForecastingWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "Forecasting", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ReportSchedulerWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ReportScheduler", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ComplianceReportingWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ComplianceReporting", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ExportManagementWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ExportManagement", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def init_ui(self) -> None:
        ...
        self.table.setColumnCount(6)
        self.table.setHorizontalHeaderLabels(
            ["Export Name", "Type", "Records", "Format", "Last Run", "Action"]
        )
        layout.addWidget(self.table)
        self.setLayout(layout)
...
class AuditTrailWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "AuditTrail", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def init_ui(self) -> None:
        ...
        self.table.setColumnCount(6)
        self.table.setHorizontalHeaderLabels(
            ["Timestamp", "User", "Action", "Resource", "Change", "Status"]
        )
        layout.addWidget(self.table)
        self.setLayout(layout)
