...
class DemandForecastingMLWidget(BaseReportWidget):
    """Demand Forecasting with ML - Predictive demand"""

    def __init__(self, db) -> None:
        columns = [
            {"header": "Date", "key": "date"},
            {"header": "Predicted Demand", "key": "predicted_demand"},
        ...
        super().__init__(db, "DemandForecastingML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ChurnPredictionMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ChurnPredictionML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            ...
            for idx, (
                ...
                self.table.setItem(idx, 2, QTableWidgetItem(str(confidence)))
                self.table.setItem(
                    idx, 3, QTableWidgetItem(str(last_activity))
                )
...
class PricingOptimizationMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "PricingOptimizationML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class CustomerClusteringMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "CustomerClusteringML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class AnomalyDetectionMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "AnomalyDetectionML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class RecommendationEngineWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "RecommendationEngine", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ResourceOptimizationMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ResourceOptimizationML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class MarketingMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "MarketingML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
...
class ModelPerformanceWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "ModelPerformance", columns)
        self.db = db
        self.init_ui()
        self.load_data()
    ...
    def load_data(self) -> None:
        try:
            models = [
                ...
                (
                    "Pricing Optimization (Neural Net)",
                    "88.5%",
                    "85.2%",
                    "87.8%",
                    "86.5%",
...
class PredictiveMaintenanceMLWidget(BaseReportWidget):
    ...
    def __init__(self, db) -> None:
        ...
        super().__init__(db, "PredictiveMaintenanceML", columns)
        self.db = db
        self.init_ui()
        self.load_data()
