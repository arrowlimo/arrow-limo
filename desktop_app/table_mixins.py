...
class DrillDownTableMixin:
    ...
    def enable_drill_down(
        ...
        Args:
            ...
            detail_callback: Optional callback function(key_value) for custom
            detail views
        """
    ...
    def on_row_double_clicked(self, index: QModelIndex) -> None:
        ...
        if key_widget:
            ...
            # Call custom callback if provided, otherwise use default charter
            # detail
...
class FilterableTableMixin:
    ...
    def add_filter_row(self, table_widget, filter_columns=None) -> None:
    ...
    def apply_filter(self, table_widget, column, filter_text) -> None:
