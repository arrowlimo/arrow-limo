#!/usr/bin/env python3
"""Add 5 of Diamonds energy drink."""
import psycopg2
import os
...
def add_product():
    ...
    # 5 of Diamonds products
    products = [
        ("5 of Diamonds Energy Drink 355ml", 2.99, 0.00, "Energy Drink", "Premium energy drink"),
        ("5 of Diamonds Energy Drink 473ml", 3.99, 0.00, "Energy Drink", "Premium energy drink"),
    ]
    ...
    cur.execute("""
        ...
        WHERE item_name LIKE '%5 of Diamonds%'
        ORDER BY item_id
    """)
    rows = cur.fetchall()
