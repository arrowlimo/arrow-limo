    ...
    def _load_run_types(self):
        ...
        try:
            ...
            for row_idx, (name, active, order) in enumerate(rows):
                ...
                # Store name for delete operations (use run_type_name as key since no id column)
    ...
    def _save_run_types(self):
        ...
        try:
            ...
            for row in range(self.run_types_table.rowCount()):
                ...
                if rid:
                    # Update existing (use run_type_name as key since no id column)
                    cur.execute("""
                        UPDATE charter_run_types
                        SET is_active = %s, display_order = %s
