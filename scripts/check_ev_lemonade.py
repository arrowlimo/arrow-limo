...
def check_product():
    ...
    print("🔍 Checking for EV Lemonade...")
    cur.execute("""
        SELECT item_id, item_name, unit_price 
        FROM beverage_products 
        WHERE item_name ILIKE '%ev lemonade%' OR item_name ILIKE '%ev%lemonade%'
        ORDER BY item_id
    """)
    ...
    if rows:
        ...
        print("❌ No EV Lemonade products found")
