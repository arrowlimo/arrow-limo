#!/usr/bin/env python3
"""
Import January 2013 CIBC banking data - VERIFIED with penny-perfect accuracy.

All 36 transactions verified against PDF reconciliation report.
Opening balance: $21.21
Closing balance: -$244.65
Net change: -$265.86
"""
...
# All verified transactions from January 2013
TRANSACTIONS = [
    ...
    ('2013-01-07', 'CORRECTION 00339', None, 316.88),
    ('2013-01-07', 'NSF CHARGE 00339', 90.00, None),
    ...
    ('2013-01-24', 'INSURANCE #5 PREMIUM FIN', 2383.24, None),
    ('2013-01-24', 'INSURANCE Coaperation CSI', 105.15, None),
    ...
    ('2013-01-31', 'INSURANCE Coaperation CSI', 105.15, None),
...
def main():
    print("\n" + "="*80)
    print("IMPORT JANUARY 2013 CIBC BANKING DATA - VERIFIED")
    print("="*80)
    ...
    # Expected totals
    print(f"\nExpected closing balance: -$244.65")
    print(f"(Opening $21.21 + net change)")
