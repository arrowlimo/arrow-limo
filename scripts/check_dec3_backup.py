...
# Check month-by-month counts in Dec 3 backup
cur.execute("""
    SELECT 
    ...
    FROM banking_transactions_scotia_2012_2013_backup_20251203
...
print("Dec 3 backup (banking_transactions_scotia_2012_2013_backup_20251203):")
