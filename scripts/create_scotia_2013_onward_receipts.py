#!/usr/bin/env python3
"""
Create receipts for Scotia Bank 2013 onward transactions.
"""
...
def main():
    ...
    try:
        ...
        print("=" * 80)
        print("SCOTIA BANK RECEIPT COVERAGE BY YEAR (2013 ONWARD)")
        print("=" * 80)
        ...
        cur.execute("""
            ...
            WHERE b.bank_id = 2
                AND EXTRACT(YEAR FROM b.transaction_date) >= 2013
        ...
        if not transactions:
            print("✅ All Scotia Bank 2013+ transactions already have receipts!")
            return
        ...
        print()
        print(f"Verification: {remaining} Scotia 2013+ transactions still need receipts")
