#!/usr/bin/env python3
"""
Analyze unmatched transactions in CIBC account 1615 (87.5% matched).
...
def main():
    ...
    print("=" * 80)
    print("CIBC ACCOUNT 1615 - UNMATCHED TRANSACTION ANALYSIS")
    print("=" * 80)
    ...
    print(f"   - This would improve match rate from 87.5% to ~{87.5 + (actionable_count/total_debits*100):.1f}%")
