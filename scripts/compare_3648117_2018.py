#!/usr/bin/env python3
"""Compare CIBC account 3648117 2018 CSV against database."""
...
# Read CSV file
csv_path = r"L:\limo\CIBC UPLOADS\3648117 (CIBC Business Deposit account, alias for 0534\cibc 8117 2018.csv"
csv_transactions = []
