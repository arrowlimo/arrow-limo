...
def main():
    ...
    cur.execute("SELECT COUNT(*), SUM(amount) FROM payments WHERE reserve_number IS NOT NULL AND amount > 0")
    ...
    cur.execute("SELECT COUNT(*), SUM(amount) FROM payments WHERE reserve_number IS NULL AND amount > 0")
