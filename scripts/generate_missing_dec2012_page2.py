#!/usr/bin/env python3
"""
Generate missing_banking_rows CSV from screenshot validation results for Page 2
"""
import csv
import os

# Read the screenshot file
screenshot_file = 'l:/limo/reports/screenshot_rows_dec2012_page2.csv'
missing_file = 'l:/limo/reports/missing_banking_rows_dec2012_page2.csv'
...
with open(screenshot_file, 'r', encoding='utf-8') as f:
    ...
    for row in reader:
        ...
        rows_to_add.append({
            ...
            'side': side,
            'description': desc,
            'notes': f'Added from CIBC Dec 2012 page 2',
