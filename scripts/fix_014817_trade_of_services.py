#!/usr/bin/env python3
"""
Fix reserve 014817 - should not be cancelled, was trade of services.
"""
...
print("=" * 120)
print("RESERVE 014817 - Trade of Services Investigation")
print("=" * 120)
print()
...
if lms_row:
    ...
    print("⚠️  Reserve 014817 NOT FOUND in LMS")
    lms_cancelled = None
print()
...
if pg_row:
    ...
    # Check if there's a trade_of_services payment method
    print("ANALYSIS:")
    if cancelled:
        print("  ⚠️  PostgreSQL shows CANCELLED")
        if lms_cancelled is not None and not lms_cancelled:
            print("  ⚠️  But LMS shows NOT CANCELLED")
            print("  → Should update PostgreSQL to match LMS")
    
    if balance == 0.01 and paid == 0:
        print("  ℹ️  $0.01 balance with $0 paid - no payments recorded")
        print("  ℹ️  If this was trade of services, payment should be recorded")
        print()
        print("RECOMMENDED ACTIONS:")
        print("  1. Uncancelled the charter (set cancelled=FALSE)")
        print("  2. Add trade_of_services payment for $0.01")
        print("  3. Update balance to $0.00")
else:
    print("⚠️  Reserve 014817 NOT FOUND in PostgreSQL")
...
if '--apply' in sys.argv:
    ...
    # Create backup
    pg_cur.execute("""
        CREATE TABLE charters_014817_backup_20251123 AS
        SELECT * FROM charters WHERE reserve_number = '014817'
    """)
    print("✓ Backup created: charters_014817_backup_20251123")
    ...
    if not has_trade:
        pg_cur.execute("""
            INSERT INTO payments (
                ...
                '2022-05-28',
                'trade_of_services',
                'Trade of services - not cancelled',
                NOW()
            )
        """)
    ...
    print()
    print("✅ SUCCESS! Reserve 014817 fixed:")
    print("   - Uncancelled")
    print("   - Trade of services payment recorded")
    print("   - Balance cleared to $0.00")
    print()
    print("Rollback: DROP TABLE charters_014817_backup_20251123;")
