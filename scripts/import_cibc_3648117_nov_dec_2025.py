#!/usr/bin/env python3
"""Import CIBC Business Deposit account 3648117 for Nov-Dec 2025."""
import psycopg2
import csv
...
print("=" * 100)
print("IMPORTING CIBC BUSINESS DEPOSIT ACCOUNT 3648117 - NOV/DEC 2025")
print("=" * 100)
print()

csv_file = r"L:\limo\CIBC UPLOADS\3648117 (CIBC Business Deposit account, alias for 0534\2025\2025cibc.csv"
...
with open(csv_file, 'r', encoding='utf-8-sig') as f:
    ...
    for row in reader:
        ...
        # Create unique hash
        hash_input = f"3648117|{tx_date}|{description}|{debit_amt}|{credit_amt}"
