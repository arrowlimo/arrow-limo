...
CLASSIFICATIONS = {
    "PAT PERRIER": {
        ...
        "notes": "AC repair for vehicles",
    },
    "VALIN HEATH": {
        "category": "DAY_LABORER_PAY",
        "status": "MANUAL_CLASSIFIED",
        "notes": "General laborer",
    },
    "GEOFF TAGG": {
        "category": "VENDOR_SERVICE",
        "status": "MANUAL_CLASSIFIED",
        "notes": "Tagg Extreme Towing - towing service",
    },
    "TABATHA WOW WIND": {
        "category": "DRIVER_BUSINESS_EXPENSE",
        "status": "MANUAL_CLASSIFIED",
        "notes": "Wow Windows (glass repair) - driver Tabatha's business expense",
    },
    "SHEILA FRIESEN": {
    ...
    "LINDA": {
        ...
        "status": "MANUAL_CLASSIFIED",
        "notes": "Client refunds",
    },
    "ONE TIME CONTACT": {
        "category": "VENDOR_ONE_TIME_PAYMENT",
        "status": "MANUAL_CLASSIFIED",
        "notes": "One-time vendor payments (bills via email transfer)",
    },
    "RD REGIONAL AIRPORT": {
        "category": "VENDOR_SERVICE",
        "status": "MANUAL_CLASSIFIED",
        "notes": "Regional airport service",
    },
    "DIRECT DIGITAL": {
        "category": "VENDOR_SERVICE",
        "status": "MANUAL_CLASSIFIED",
        "notes": "IT/tech vendor services",
    },
    "DARRYL TABOO SHOWS": {
        "category": "VENDOR_SERVICE",
        "status": "MANUAL_CLASSIFIED",
        "notes": "Entertainment/shows vendor",
    },
    "SERENA BOOK KEEPER": {
        "category": "CONTRACTOR_BOOKKEEPER",
        "status": "MANUAL_CLASSIFIED",
        "notes": "Contractor bookkeeper services",
    },
}
