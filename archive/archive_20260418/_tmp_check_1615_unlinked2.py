"""
Detailed breakdown of unlinked 2012 txns for account 1615.
"""
import psycopg2
...
cur.execute("""
    SELECT
        bt.transaction_date, bt.debit_amount, bt.credit_amount, bt.description, bt.transaction_id,
        bt.reconciliation_status, bt.is_transfer
