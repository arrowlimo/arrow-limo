...
CATEGORY_GL_MAPPING = {
    ...
    'Bank Fees': ('5710', None, False),  # Bank Fees & Service Charges
    'Bank Charges': ('5710', None, False),
    'bank_fees': ('5710', None, False),
    ...
    'Merchant Services': ('5720', None, False),  # Credit Card Processing Fees
