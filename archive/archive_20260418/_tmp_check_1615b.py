...
print('vendor_accounts cols:', [r[0] for r in cur.fetchall()])

cur.execute("SELECT account_id, vendor_name, canonical_vendor FROM vendor_accounts WHERE account_id = 1615 LIMIT 5")
rows = cur.fetchall()
