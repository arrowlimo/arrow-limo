...
Write-ReportLine "winner winner chicken dinner"
...
Write-Host "Local installer log: $script:LocalLogPath"
Close-InstallUi
Show-InstallMessage -Message "winner winner chicken dinner`r`n`r`nInstall complete.`r`nTarget: $TargetRoot`r`nReport: $script:ReportPath"
Release-InstallerMutex
Stop-Transcript | Out-Null
