...
echo Running Arrow Limousine installer (delta mode)...
...
if not "%EXITCODE%"=="0" (
    ...
    echo Report: Y:\limo\_install_reports\latest_install_report.txt
    echo Local log: C:\ProgramData\ArrowLimoInstaller\
    exit /b %EXITCODE%
)
