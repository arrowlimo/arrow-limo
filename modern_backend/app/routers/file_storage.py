...
ROLE_PERMISSIONS = {
    "admin": ["employees", "vehicles", "business_documents", "banking_records", "reports", "backups"],
...
def check_access(category: str, user_role: str, employee_id: Optional[int] = None, target_employee_id: Optional[int] = None) -> bool:
