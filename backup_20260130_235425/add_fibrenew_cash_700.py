...
- Date: March 26, 2019  
- Amount: $700.00 (Cash)
- Invoice 7598 (Rent): $472.50
- Invoice 7704 (Utilities): $227.50
...
def add_fibrenew_cash_payment():
    ...
    # Insert the cash payment (using checking account)
        cur.execute("""
            INSERT INTO banking_transactions 
                (account_number, transaction_date, description, credit_amount, debit_amount, category)
            VALUES (%s, %s, %s, %s, %s, %s)
            RETURNING transaction_id
    """, ('0228362', payment_date, description, payment_amount, 0, 'Rent/Utilities'))
        ...
        print(f"\nNow rebuilding Fibrenew ledger...")
