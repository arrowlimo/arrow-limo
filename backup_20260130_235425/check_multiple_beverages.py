...
def check_products():
    ...
    searches = [
        ("Too Hoots Hard Ice Tea", "%too hoots%"),
        ("Absolute Coolers", "%absolute cooler%"),
        ("American Vintage", "%american vintage%"),
        ("Arizona Hard Ice Tea", "%arizona hard%"),
        ("Bacardi Coolers", "%bacardi cooler%"),
        ("Mudslide", "%mudslide%"),
        ("Blackfly Cocktail", "%blackfly%"),
    ]
