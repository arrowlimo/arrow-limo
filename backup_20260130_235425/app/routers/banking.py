...
def get_reconciliation_status():
    ...
    return {
        "deposits": {
            ...
            "match_rate": (deposit_match[0] / deposit_match[1] * 100) if deposit_match[1] > 0 else 0.0
        },
        "expenses": {
            "unmatched_count": unmatched_expenses[0],
            "unmatched_amount": float(unmatched_expenses[1]) if unmatched_expenses[1] else 0.0,
            "match_rate": (expense_match[0] / expense_match[1] * 100) if expense_match[1] > 0 else 0.0
        }
    }
