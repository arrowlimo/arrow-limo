...
class EnhancedCharterListWidget(QWidget, DrillDownTableMixin):
    ...
    def _clear_dates(self):
        """Clear both date fields to show all charters"""
        self.date_from.setText("")
        self.date_to.setText("")
        self.load_data()  # Reload with no date filters
    ...
    def apply_filters(self):
        ...
        for i in range(self.table.rowCount()):
            ...
            status = self.table.item(i, 5).text().lower()  # Make case-insensitive
            ...
            if status_filter_lower != "all" and status != status_filter_lower:
                show = False
                show = False
