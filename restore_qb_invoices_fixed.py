#!/usr/bin/env python3
"""
Restore qb_export_invoices from Neon to local (with proper column handling)
"""
import psycopg2
...
try:
    ...
    for col_name, col_type, is_nullable in columns:
        nullable = "" if col_type.startswith("integer") and "Invoice" in col_name else ""  # Invoice # is PK
